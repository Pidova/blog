...
printf("%d, %d\n", hello, hello);
```
![CFG Graph]({{ site.baseurl }}/assets/files/decompilerconstruction/chapter7/IRgraph.svg)

[Download GraphViz Example]({{ site.baseurl }}/assets/files/decompilerconstruction/chapter7/IR_Example.dot)
