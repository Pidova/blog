...
printf("%d, %d\n", hello, hello);
```
![CFG Graph](/assets/files/decompilerconstruction/chapter7/IRgraph.svg)

[Download GraphViz Example](/assets/files/decompilerconstruction/chapter7/IR_Example.dot)
...
Example of this is with the followin

### Algorithm

The standard approach for constructing SSA form is the Cytron et al. algorithm using dominance frontiers.

It operates by first computing the control-flow graph (CFG) and dominator tree, then using dominance frontiers to determine where φ (phi) definitions are required.
