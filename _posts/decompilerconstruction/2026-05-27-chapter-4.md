...
printf("%d, %d\n", hello, hello);
```
![CFG Graph](https://pidova.github.io/assets/files/decompilerconstruction/chapter4/graph.svg)

[Download GraphViz Example](https://pidova.github.io/assets/files/decompilerconstruction/chapter4/IR_Example.dot)
